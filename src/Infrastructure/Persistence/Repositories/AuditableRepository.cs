...
public abstract class AuditableRepository<TEntity> : Repository<TEntity> where TEntity : class, IEntity, IAuditableEntity
{
	public AuditableRepository(IDbContext dbContext, ILogger<AuditableRepository<TEntity>> logger, ITableNameResolver tableNameResolver, IColumnNameResolver columnNameResolver) 
