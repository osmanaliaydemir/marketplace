...
/// <summary>
/// Ürün varyantı güncelleme isteği için validasyon kuralları
/// </summary>
public sealed class UpdateProductVariantRequestValidator : AbstractValidator<UpdateProductVariantRequest>
{
    public UpdateProductVariantRequestValidator()
    {
        ...
        RuleFor(x => x.VariantName)
            ...
            .WithMessage("Varyant adı sadece harf, rakam, boşluk, tire, nokta ve parantez içerebilir");
        ...
        RuleFor(x => x.IsActive)
            .NotNull().WithMessage("Aktiflik durumu gereklidir");
    }
}
