USE [Marketplace]
GO
/****** Object:  Table [dbo].[app_users]    Script Date: 15.08.2025 17:51:34 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[categories]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[inventories]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ledger_postings]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ledger_transactions]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[order_groups]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[order_items]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[orders]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[outbox_messages]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[payment_splits]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[payments]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[product_variants]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[products]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[refund_items]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[refunds]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[sellers]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[shipments]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[store_categories]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[stores]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[webhook_deliveries]    Script Date: 15.08.2025 17:51:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[app_users] ADD  DEFAULT (sysutcdatetime()) FOR [created_at]
GO
ALTER TABLE [dbo].[app_users] ADD  DEFAULT ((1)) FOR [is_active]
GO
...
REFERENCES [dbo].[payments] ([id])
GO
ALTER TABLE [dbo].[sellers]  WITH CHECK ADD FOREIGN KEY([user_id])
REFERENCES [dbo].[app_users] ([id])
GO
ALTER TABLE [dbo].[shipments]  WITH CHECK ADD FOREIGN KEY([order_group_id])
REFERENCES [dbo].[order_groups] ([id])
GO
ALTER TABLE [dbo].[store_categories]  WITH CHECK ADD FOREIGN KEY([global_category_id])
REFERENCES [dbo].[categories] ([id])
GO
...
CREATE TABLE [dbo].[store_applications](
    ...
    [status] [tinyint] NOT NULL, -- 1:Pending, 2:Approved, 3:Rejected, 4:Cancelled
    [rejection_reason] [nvarchar](500) NULL,
    [approved_at] [datetime2](3) NULL,
    [approved_by_user_id] [bigint] NULL,
    [seller_id] [bigint] NULL, -- Onaylandıktan sonra
    [created_at] [datetime2](3) NULL,
    [modified_at] [datetime2](3) NULL,
